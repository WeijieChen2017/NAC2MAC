...
def smooth_L1_loss(y_true, y_pred):
    return tensorflow.losses.huber_loss(y_true, y_pred)
...
def execute():
    ...
    model_name = 'tofnac2mac'

    X_folder = 'tofnac_to_mac/X'
    Y_folder = 'tofnac_to_mac/Y'

    X_progress_file = 'tofnac_to_mac/X/val/X_00116_00000009.tiff'
    Y_progress_file = 'tofnac_to_mac/Y/val/Y_00116_00000009.tiff'
